                ...
                <div className="flex flex-col 2xl:flex-row gap-10 2xl:gap-28">
                    <div className="flex flex-col gap-5 2xl:gap-7 w-full 2xl:max-w-2xl 2xl:w-full">
                        ...
                        <div className="flex flex-col gap-5 2xl:gap-7">
                            ...
                            <p className="2xl:max-w-sm text-secondary/70 dark:text-white/70">We bring over a decade of experience delivering reliable broadcast infrastructure, premium equipment, and flawless execution for some of India’s biggest productions.
Our focus is simple: zero downtime, perfect transmission, and world-class production quality.</p>
                        </div>
                    </div>
                    <div className="grid md:grid-cols-3 gap-5 2xl:gap-7">
                        <div className="relative bg-primary p-4 2xl:p-7 flex flex-col justify-between gap-8 md:gap-0">
                            <div className="relative z-10 flex flex-col gap-2 lg:gap-4">
                                ...
                                <p className="dark:text-secondary">Leema Solutions delivered flawless broadcast infrastructure for our live production. 
Their technical team ensured every moment was captured perfectly.</p>
                            </div>
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-2 lg:gap-5 pt-5">
                                    ...
                                    <div>
                                        <p className="font-medium dark:text-secondary">Production Director</p>
                                        <p className="text-base text-secondary/70">Broadcast Network Partner</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative overflow-hidden p-5 2xl:p-7 border border-secondary/12 dark:border-white/30 flex flex-col justify-between gap-8 md:gap-0">
                            <div className="relative z-10">
                                <h2>50++</h2>
                                <p>Major productions and events supported across India</p>
                            </div>
                            <div className="flex flex-col gap-4 relative z-10">
                                ...
                                <h2>Leema Solutions</h2>
                                <p>Trusted by leading broadcasters, production houses, and corporate brands to deliver reliable media and technology solutions.</p>
                            </div>
