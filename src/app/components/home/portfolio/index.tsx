                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">A showcase of high-impact productions powered by Leema Solutions — from live sports broadcasts and reality TV to esports tournaments and large-scale corporate events.</p>
                                </div>
                            </div>
                        </div>
                    </div>
