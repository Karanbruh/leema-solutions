                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">Trusted by broadcasters, production houses, and event organizers to deliver flawless technical execution for live productions and major events.</p>
                                </div>
                            </div>
                        </div>
                        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-7">
                            <div className="bg-primary p-4 lg:p-7 flex flex-col gap-32">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <h5 className="dark:text-secondary">{testimonialData?.data_1?.title}</h5>
                                </div>
                            ...
                            <div className="xl:col-span-2 bg-secondary dark:bg-lightgray/10 p-4 lg:p-7 flex flex-col justify-between gap-14">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <h5 className="text-white">{testimonialData?.data_2?.title}</h5>
                            ...
                            <div className="bg-white dark:bg-black/20 p-4 lg:p-7 flex flex-col justify-between gap-32">
                                <div className="flex flex-col gap-6">
                                    ...
                                    <h5>{testimonialData?.data_3?.title}</h5>
                                </div>
                                <div className="flex items-center gap-4">
